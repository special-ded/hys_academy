...
export class Form {
  ...
  nameInput: string = (document.querySelector('#username') as HTMLInputElement).value;
  phoneInput: string = (document.querySelector('#telephone') as HTMLInputElement).value;
  emailInput: string = (document.querySelector('#email') as HTMLInputElement).value;
